...
func TestStoreCodeProposal(t *testing.T) {
	...
	myActorAddress := "cosmos10d07y265gmmuvt4z0w9aw880jnsr700j6zn9kn"
	fmt.Println(myActorAddress)
	...
	msgs := []sdk.Msg{msgContent}

	// when stored
	_, err = govKeeper.SubmitProposal(ctx, msgs, nil)
	require.NoError(t, err)
