...
func setupKeeper(t *testing.T) (*Keeper, sdk.Context, []sdk.StoreKey) {
	...
	srcKeeper := NewKeeper(encodingConfig.Marshaler, keyWasm, pk.Subspace(wasmTypes.DefaultParamspace), authkeeper.AccountKeeper{}, nil, stakingkeeper.Keeper{}, distributionkeeper.Keeper{}, nil, nil, nil, nil, nil, nil, msgRouter, nil, tempDir, wasmConfig, SupportedFeatures)
