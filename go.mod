...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/notional-labs/cosmos-sdk-rollkit v0.50.6-notional
	...
	github.com/rollkit/rollkit => github.com/notional-labs/rollkit v0.11.9-notional-4
